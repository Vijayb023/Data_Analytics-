...
public class graduate extends student {
	...
	public boolean equals(graduate name) {
		if((major==name.major)&&(getGpa()==name.getGpa())&&(getCreditHours()==name.getCreditHours())&&(getDegree()==name.getDegree())&&(getYear()==name.getYear())&&(getConcentration()==name.getConcentration())&&(getYear()==name.getYear())) {
			return true;
		}
		else {
			return false; 
